            ...
            PostResponseAsyncTask task = new PostResponseAsyncTask(LoginActivity.this, data, new AsyncResponse() {
                ...
                public void processFinish(String s) {
                   if (s.contains("success")){
                       Intent in = new Intent(LoginActivity.this, NewsListActivity.class);
                       startActivity(in);
                   }else {
                       Toast.makeText(LoginActivity.this,"Your Username and Password is not match", Toast.LENGTH_SHORT).show();
                   }
                }
            });
            task.execute("http://10.0.2.2:8080/TNews/login.php");
        }
    }
